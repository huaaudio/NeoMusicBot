...
final class SlashCommandSchema
{
    ...
    static List<CommandData> create()
    {
        ...
        commands.add(Commands.slash("about", "Show information about NeoMusicBot"));
        commands.add(Commands.slash("ping", "Show the Discord gateway latency"));
        commands.add(Commands.slash("help", "Show the available NeoMusicBot commands"));
        ...
        SlashCommandData config = guild(Commands.slash("config", "Configure NeoMusicBot for this server")
                .addSubcommands(
                        new SubcommandData("show", "Show this server's NeoMusicBot settings"),
        ...
        commands.add(guild(Commands.slash("owner", "Bot-owner maintenance commands")
                .addSubcommands(
                        ...
                        new SubcommandData("shutdown", "Shut down NeoMusicBot cleanly"))));
